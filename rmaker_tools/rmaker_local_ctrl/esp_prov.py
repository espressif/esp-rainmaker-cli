...
# Import from our local modules to avoid ESP-IDF dependencies
try:
    from . import prov
    from . import transport
    # Import security from rmaker_prov to use shared components  
    sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'rmaker_prov'))
    import security
except ImportError:
