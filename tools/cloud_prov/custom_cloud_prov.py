...
def custom_cloud_config_request(security_ctx, userid, secretkey):
    ...
    cmd = cloud_proto.custom_cloud_config_pb2.CloudConfigPayload()
    cmd.msg = cloud_proto.custom_cloud_config_pb2.TypeCmdGetSetDetails
...
def custom_cloud_config_response(security_ctx, response_data):
    ...
    cmd_resp = cloud_proto.custom_cloud_config_pb2.CloudConfigPayload()
